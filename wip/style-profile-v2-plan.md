...
- [ ] Document v2 success criteria (analysis + generation) in a single place (recommended path: `docs/quality-gates.md`).
...
- [ ] Create `docs/style-profile-spec.md` as the canonical schema/spec:
