...
## Included Example (Derived Only)

This repo includes one checked-in example profile run under `artefacts/trump-tweets/20260222_1215_trump-tweets/`.

- This is derived output generated by StyleModeler (not raw source data).
- The source dataset CSV is intentionally not included in this repo.
- The example was generated from the public Trump Twitter Archive dataset on Kaggle:
  - https://www.kaggle.com/datasets/headsortails/trump-twitter-archive
  - License: CC0: Public Domain
  - Dataset link included as source credit.

This repo also includes two example bundles generated from that same run:

- Inline: `bundles/styleprofile-trump-tweets-en-20260222.inline.md`
- Zip: `bundles/styleprofile-trump-tweets-en-20260222.styleprofile.zip`
...
Note: `sources/` and most of `artefacts/` are ignored by git by default (except the checked-in example run).
